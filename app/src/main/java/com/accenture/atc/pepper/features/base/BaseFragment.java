package com.accenture.atc.pepper.features.base;
...
import com.accenture.atc.pepper.injection.component.ConfigPersistentComponent;
import com.accenture.atc.pepper.injection.component.DaggerConfigPersistentComponent;
import com.accenture.atc.pepper.injection.component.FragmentComponent;
        ...
        if (componentsArray.get(fragmentId) == null) {
            ...
            configPersistentComponent =
                    DaggerConfigPersistentComponent.builder()
                            .appComponent(PepperRobotApplication.get(getActivity()).getComponent())
                            .build();
